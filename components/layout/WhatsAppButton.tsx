...
export function WhatsAppButton() {
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 w-14 h-14 bg-[var(--color-whatsapp)] rounded-full flex items-center justify-center shadow-lg hover:scale-110 transition-transform group"
