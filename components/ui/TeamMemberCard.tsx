...
export function TeamMemberCard({ name, role, image, bio }: TeamMemberCardProps) {
  return (
    <div className="rounded-2xl border border-white/10 bg-gradient-to-b from-[var(--color-gray-skeleton)] to-[#1a1a1a] overflow-hidden group transition-transform duration-300 hover:-translate-y-1">
      ...
      <div className="p-5">
        ...
        <p className="text-[var(--color-silver-muted)] text-sm mt-1">{role}</p>
